...
// actual class may be a subclass -- as returned by PermissionsPeer::getOMClass()
include_once 'classes/model/Permissions.php';
...
abstract class BasePermissionsPeer {
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(PermissionsPeer::PER_UID);
			$selectCriteria->add(PermissionsPeer::PER_UID, $criteria->remove(PermissionsPeer::PER_UID), $comparison);
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(PermissionsPeer::PER_UID, (array) $values, Criteria::IN);
		}
	...
	public static function retrieveByPK($pk, $con = null)
	{
		...
		$criteria->add(PermissionsPeer::PER_UID, $pk);
