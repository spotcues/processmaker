...
/**
 * This class adds structure of 'OAUTH_ACCESS_TOKENS' table to 'workflow' DatabaseMap object.
 *
 *
 *
 ...
 */
class OauthAccessTokensMapBuilder
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'classes.model.map.OauthAccessTokensMapBuilder';
