...
/**
 * This class adds structure of 'OAUTH_AUTHORIZATION_CODES' table to 'workflow' DatabaseMap object.
 *
 *
 *
 ...
 */
class OauthAuthorizationCodesMapBuilder
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'classes.model.map.OauthAuthorizationCodesMapBuilder';
