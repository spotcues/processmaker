...
// actual class may be a subclass -- as returned by OauthRefreshTokensPeer::getOMClass()
include_once 'classes/model/OauthRefreshTokens.php';

/**
 * Base static class for performing query and update operations on the 'OAUTH_REFRESH_TOKENS' table.
 *
 * 
 *
 * @package    workflow.classes.model.om
 */
abstract class BaseOauthRefreshTokensPeer
{
    ...
    const CLASS_DEFAULT = 'classes.model.OauthRefreshTokens';
    ...
    const USER_ID = 'OAUTH_REFRESH_TOKENS.USER_ID';

    /** the column name for the EXPIRES field */
    const EXPIRES = 'OAUTH_REFRESH_TOKENS.EXPIRES';

    /** the column name for the SCOPE field */
    const SCOPE = 'OAUTH_REFRESH_TOKENS.SCOPE';
