...
// actual class may be a subclass -- as returned by AppFolderPeer::getOMClass()
include_once 'classes/model/AppFolder.php';

/**
 * Base static class for performing query and update operations on the 'APP_FOLDER' table.
 *
 * 
 *
