...
// actual class may be a subclass -- as returned by CalendarAssignmentsPeer::getOMClass()
include_once 'classes/model/CalendarAssignments.php';

/**
 * Base static class for performing query and update operations on the 'CALENDAR_ASSIGNMENTS' table.
 *
 * 
 *
