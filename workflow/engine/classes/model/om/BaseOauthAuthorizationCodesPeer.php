...
// actual class may be a subclass -- as returned by OauthAuthorizationCodesPeer::getOMClass()
include_once 'classes/model/OauthAuthorizationCodes.php';

/**
 * Base static class for performing query and update operations on the 'OAUTH_AUTHORIZATION_CODES' table.
 *
 * 
 *
 * @package    workflow.classes.model.om
 */
abstract class BaseOauthAuthorizationCodesPeer
{
    ...
    const CLASS_DEFAULT = 'classes.model.OauthAuthorizationCodes';
    ...
    const AUTHORIZATION_CODE = 'OAUTH_AUTHORIZATION_CODES.AUTHORIZATION_CODE';

    /** the column name for the CLIENT_ID field */
    const CLIENT_ID = 'OAUTH_AUTHORIZATION_CODES.CLIENT_ID';

    /** the column name for the USER_ID field */
    const USER_ID = 'OAUTH_AUTHORIZATION_CODES.USER_ID';

    /** the column name for the REDIRECT_URI field */
    const REDIRECT_URI = 'OAUTH_AUTHORIZATION_CODES.REDIRECT_URI';

    /** the column name for the EXPIRES field */
    const EXPIRES = 'OAUTH_AUTHORIZATION_CODES.EXPIRES';

    /** the column name for the SCOPE field */
    const SCOPE = 'OAUTH_AUTHORIZATION_CODES.SCOPE';
    ...
    private static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('AuthorizationCode', 'ClientId', 'UserId', 'RedirectUri', 'Expires', 'Scope', ),
