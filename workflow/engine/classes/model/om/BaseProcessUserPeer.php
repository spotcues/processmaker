...
// actual class may be a subclass -- as returned by ProcessUserPeer::getOMClass()
include_once 'classes/model/ProcessUser.php';

/**
 * Base static class for performing query and update operations on the 'PROCESS_USER' table.
 *
 * 
 *
