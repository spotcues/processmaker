...
// actual class may be a subclass -- as returned by OauthAccessTokensPeer::getOMClass()
include_once 'classes/model/OauthAccessTokens.php';

/**
 * Base static class for performing query and update operations on the 'OAUTH_ACCESS_TOKENS' table.
 *
 * 
 *
 * @package    workflow.classes.model.om
 */
abstract class BaseOauthAccessTokensPeer
{
    ...
    const CLASS_DEFAULT = 'classes.model.OauthAccessTokens';
    ...
    const ACCESS_TOKEN = 'OAUTH_ACCESS_TOKENS.ACCESS_TOKEN';

    /** the column name for the CLIENT_ID field */
    const CLIENT_ID = 'OAUTH_ACCESS_TOKENS.CLIENT_ID';

    /** the column name for the USER_ID field */
    const USER_ID = 'OAUTH_ACCESS_TOKENS.USER_ID';

    /** the column name for the EXPIRES field */
    const EXPIRES = 'OAUTH_ACCESS_TOKENS.EXPIRES';

    /** the column name for the SCOPE field */
    const SCOPE = 'OAUTH_ACCESS_TOKENS.SCOPE';
    ...
    private static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('AccessToken', 'ClientId', 'UserId', 'Expires', 'Scope', ),
