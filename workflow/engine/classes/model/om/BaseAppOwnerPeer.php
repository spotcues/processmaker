...
// actual class may be a subclass -- as returned by AppOwnerPeer::getOMClass()
include_once 'classes/model/AppOwner.php';

/**
 * Base static class for performing query and update operations on the 'APP_OWNER' table.
 *
 * 
 *
