...
// actual class may be a subclass -- as returned by IsoSubdivisionPeer::getOMClass()
include_once 'classes/model/IsoSubdivision.php';

/**
 * Base static class for performing query and update operations on the 'ISO_SUBDIVISION' table.
 *
 * 
 *
