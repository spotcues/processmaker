...
// actual class may be a subclass -- as returned by IsoCountryPeer::getOMClass()
include_once 'classes/model/IsoCountry.php';

/**
 * Base static class for performing query and update operations on the 'ISO_COUNTRY' table.
 *
 * 
 *
