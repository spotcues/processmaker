...
// actual class may be a subclass -- as returned by IsoLocationPeer::getOMClass()
include_once 'classes/model/IsoLocation.php';

/**
 * Base static class for performing query and update operations on the 'ISO_LOCATION' table.
 *
 * 
 *
