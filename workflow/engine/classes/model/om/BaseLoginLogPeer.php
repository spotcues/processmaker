...
// actual class may be a subclass -- as returned by LoginLogPeer::getOMClass()
include_once 'classes/model/LoginLog.php';

/**
 * Base static class for performing query and update operations on the 'LOGIN_LOG' table.
 *
 * 
 *
