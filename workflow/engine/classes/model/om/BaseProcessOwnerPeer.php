...
// actual class may be a subclass -- as returned by ProcessOwnerPeer::getOMClass()
include_once 'classes/model/ProcessOwner.php';

/**
 * Base static class for performing query and update operations on the 'PROCESS_OWNER' table.
 *
 * 
 *
