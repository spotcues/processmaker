...
// actual class may be a subclass -- as returned by TriggersPeer::getOMClass()
include_once 'classes/model/Triggers.php';

/**
 * Base static class for performing query and update operations on the 'TRIGGERS' table.
 *
 * 
 *
