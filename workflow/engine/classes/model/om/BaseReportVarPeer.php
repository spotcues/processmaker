...
// actual class may be a subclass -- as returned by ReportVarPeer::getOMClass()
include_once 'classes/model/ReportVar.php';

/**
 * Base static class for performing query and update operations on the 'REPORT_VAR' table.
 *
 * 
 *
