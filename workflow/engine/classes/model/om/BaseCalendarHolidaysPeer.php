...
// actual class may be a subclass -- as returned by CalendarHolidaysPeer::getOMClass()
include_once 'classes/model/CalendarHolidays.php';

/**
 * Base static class for performing query and update operations on the 'CALENDAR_HOLIDAYS' table.
 *
 * 
 *
