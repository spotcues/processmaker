...
// actual class may be a subclass -- as returned by StagePeer::getOMClass()
include_once 'classes/model/Stage.php';

/**
 * Base static class for performing query and update operations on the 'STAGE' table.
 *
 * 
 *
