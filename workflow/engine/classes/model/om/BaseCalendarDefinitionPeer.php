...
// actual class may be a subclass -- as returned by CalendarDefinitionPeer::getOMClass()
include_once 'classes/model/CalendarDefinition.php';

/**
 * Base static class for performing query and update operations on the 'CALENDAR_DEFINITION' table.
 *
 * 
 *
