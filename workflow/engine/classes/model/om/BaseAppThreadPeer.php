...
// actual class may be a subclass -- as returned by AppThreadPeer::getOMClass()
include_once 'classes/model/AppThread.php';

/**
 * Base static class for performing query and update operations on the 'APP_THREAD' table.
 *
 * 
 *
