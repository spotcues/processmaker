...
// actual class may be a subclass -- as returned by DimTimeDelegatePeer::getOMClass()
include_once 'classes/model/DimTimeDelegate.php';

/**
 * Base static class for performing query and update operations on the 'DIM_TIME_DELEGATE' table.
 *
 * 
 *
